<aside class="w-64 bg-gray-900 text-white flex flex-col fixed h-full">
    ...
    <nav class="flex-1 p-4 space-y-2 overflow-y-auto">
        ...
        <a href="{{ route('workload-subject.index') }}" class="flex items-center gap-3 px-3 py-2 rounded-lg {{ request()->routeIs('workload-subject.*') ? 'bg-brand-primary text-white' : 'text-gray-300 hover:bg-gray-800 hover:text-white' }} transition-colors">
        ...
        <a href="{{ route('activity-log.index') }}" class="flex items-center gap-3 px-3 py-2 rounded-lg {{ request()->routeIs('activity-log.*') ? 'bg-brand-primary text-white' : 'text-gray-300 hover:bg-gray-800 hover:text-white' }} transition-colors">
