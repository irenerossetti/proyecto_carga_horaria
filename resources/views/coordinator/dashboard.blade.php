...
<body class="h-full font-sans antialiased text-neutral-900 bg-[#F5F5F5]">
    ...
    <div class="flex h-screen overflow-hidden">
        <div class="w-64 bg-brand-primary flex flex-col text-white flex-shrink-0">
        ...
        <main class="flex-1 overflow-y-auto">
            <header class="bg-white border-b border-gray-200 h-16 flex items-center justify-between px-8 sticky top-0 z-10">
                <h1 class="text-xl font-semibold text-gray-800">Panel de Coordinación</h1>
                <div class="flex items-center gap-2 text-sm text-gray-500 bg-gray-50 px-3 py-1.5 rounded-full">
                    <span class="w-2 h-2 bg-green-500 rounded-full animate-pulse"></span>
                    Periodo II-2025 Activo
                </div>
            </header>
            ...
            <div class="p-8 max-w-7xl mx-auto space-y-8">
                ...
                <div class="grid grid-cols-1 md:grid-cols-4 gap-4">
                    <div class="bg-white p-6 rounded-xl shadow-sm border border-gray-200">
                        <div class="flex items-center justify-between">
                            <div class="flex-1">
                                <p class="text-sm font-medium text-gray-500">Choques de Horario</p>
                                <p class="text-3xl font-bold text-gray-900 mt-2">{{ $conflictsCount ?? 0 }}</p>
                            </div>
                            <div class="p-3 bg-red-50 rounded-lg">
                                <svg class="w-8 h-8 text-red-600" fill="none" viewBox="0 0 24 24" stroke="currentColor"><path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M12 8v4m0 4h.01M21 12a9 9 0 11-18 0 9 9 0 0118 0z" /></svg>
                            </div>
                        </div>
                    </div>
                    <div class="bg-white p-6 rounded-xl shadow-sm border border-gray-200">
                        <div class="flex items-center justify-between">
                            <div class="flex-1">
                                <p class="text-sm font-medium text-gray-500">Sin Aula Asignada</p>
                                <p class="text-3xl font-bold text-gray-900 mt-2">{{ $schedulesWithoutRoom ?? 0 }}</p>
                            </div>
                            <div class="p-3 bg-amber-50 rounded-lg">
                                <svg class="w-8 h-8 text-amber-600" fill="none" viewBox="0 0 24 24" stroke="currentColor"><path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M19 21V5a2 2 0 00-2-2H7a2 2 0 00-2 2v16m14 0h2m-2 0h-5m-9 0H3m2 0h5M9 7h1m-1 4h1m4-4h1m-1 4h1m-5 10v-5a1 1 0 011-1h2a1 1 0 011 1v5m-4 0h4" /></svg>
                            </div>
                        </div>
                    </div>
                    <div class="bg-white p-6 rounded-xl shadow-sm border border-gray-200">
                        <div class="flex items-center justify-between">
                            <div class="flex-1">
                                ...
                                <p class="text-3xl font-bold text-gray-900 mt-2">{{ $freeRoomsToday ?? 0 }}</p>
                            </div>
                    ...
                    <div class="bg-white p-6 rounded-xl shadow-sm border border-gray-200">
                        <div class="flex items-center justify-between">
                            <div class="flex-1">
                                <p class="text-sm font-medium text-gray-500">Avance Programación</p>
                                <p class="text-3xl font-bold text-gray-900 mt-2">{{ $programmingProgress ?? 0 }}%</p>
                            </div>
                ...
                <div class="grid grid-cols-1 lg:grid-cols-3 gap-8">
                    <div class="lg:col-span-2 bg-white rounded-xl shadow-card border border-gray-200 overflow-hidden">
                        <div class="px-6 py-4 border-b border-gray-100 flex items-center justify-between bg-red-50/30">
                        ...
                        <div class="divide-y divide-gray-100">
                            <div class="p-4 flex items-center justify-between hover:bg-gray-50">
                                <div>
                                    <p class="font-medium text-gray-900">Choque de Aula: 236-21</p>
                                ...
                                <button class="px-3 py-1.5 bg-white border border-gray-300 text-sm font-medium rounded-lg hover:bg-gray-50 hover:border-gray-400 transition-colors">
                                    Resolver
                                </button>
                            </div>
                             <div class="p-4 flex items-center justify-between hover:bg-gray-50">
                                <div>
                                    <p class="font-medium text-gray-900">Docente con cruce de horario</p>
                                    <p class="text-sm text-gray-500 mt-1">
                    ...
                    <div class="space-y-6">
                        <div class="bg-white rounded-xl shadow-card border border-gray-200 p-6">
                            <h3 class="font-semibold text-gray-900 mb-4">Gestión Rápida</h3>
                            <div class="space-y-3">
